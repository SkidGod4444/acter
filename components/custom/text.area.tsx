  ...
  ({ className, onInput, onKeyDown, ...props }, ref) => {
    ...
    return (
      <textarea
        ...
        className={cn(
          "flex min-h-[20px] max-h-[80px] w-full rounded-md bg-transparent p-2 text-sm shadow-sm placeholder:text-muted-foreground resize-none border border-transparent focus-visible:ring-0 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        onInput={handleInput}
