...
import { MenuIcon, PlusIcon, BookOpenIcon, LayoutDashboardIcon, ChevronLeftIcon, PaperclipIcon, ArrowUpIcon, MoveUpRight } from "lucide-react"
    ...
    <div className="flex h-screen items-center justify-center dark:bg-black dark:text-white bg-background text-black font-[family-name:var(--font-geist-regular)] overflow-hidden">
      ...
      {user && (
        <div className={cn(
          ...
          <div className="flex items-center justify-between p-2">
            <span className={cn("text-2xl font-bold", !isSidebarExpanded && "hidden")}>Acter</span>
            <Button 
              variant="ghost" 
              size="icon"
      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4 mb-8">
          <h2 className="text-4xl mb-4 font-[family-name:var(--font-geist-bold)] tracking-tighter select-none">What can I help you ship?</h2>
          <p className="text-sm mb-4 select-none dark:text-white text-muted-foreground">Am the one who supports Acternity UI, ask question, debug code.</p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Badge variant={"secondary"} className="cursor-pointer rounded-xl border border-muted-foreground">Generate a SaaS pricing calculator
            <MoveUpRight className="size-3 ml-1" />
            </Badge>
            <Badge variant={"secondary"} className="cursor-pointer rounded-xl border border-muted-foreground">How can I structure LLM output?
            <MoveUpRight className="size-3 ml-1" />
            </Badge>
            <Badge variant={"secondary"} className="cursor-pointer rounded-xl border border-muted-foreground">Write code to implement a min heap
            <MoveUpRight className="size-3 ml-1" />
            </Badge>
          </div>
        </main>
        <footer className="p-8">
          <div className="flex justify-center items-center text-xs text-gray-500">
            <div className="flex items-center">
              <a href="/legal/ai-policy" className="hover:underline">Terms</a>
              <div className="h-4 w-px bg-gray-300 mx-2"></div>
              <a href="/legal/agreement" className="hover:underline">AI Policy</a>
              <div className="h-4 w-px bg-gray-300 mx-2"></div>
              <a href="/legal/privacy-policy" className="hover:underline">Privacy</a>
            </div>
            <div className="h-4 w-px bg-gray-300 mx-2"></div>
            <a href={OfcLinks.portfolio} className="hover:underline">By Saidev Dhal</a>
          </div>
        </footer>
      </div>
    </div>
